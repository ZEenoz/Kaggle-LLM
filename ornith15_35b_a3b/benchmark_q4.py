#!/usr/bin/env python3
"""End-to-end benchmarking harness for Ornith-1.5-35B-A3B (Q4_K_M) on 2x Tesla T4.
...
def default_workdir() -> Path:
    return Path("/kaggle/tmp/ornith_bench" if is_kaggle() else "/tmp/ornith_bench")
...
# ============================================================================
# Model + llama.cpp provisioning (same strategy as kernel/serve_ornith.py)
# ============================================================================
...
def write_outputs(out_dir: Path, results: dict, speed_spot: dict) -> None:
    ...
    md = ["# Ornith-1.5-35B-A3B Q4_K_M Benchmark Summary", ""]
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Benchmarks Ornith-1.5-35B-A3B Q4_K_M: speed/VRAM/RAM, PPL, "
    ...
    parser.add_argument("--workdir", default=None, help="Scratch dir (default /kaggle/tmp/ornith_bench)")
